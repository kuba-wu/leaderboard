...
public class ClassificationResource {
    ...
    @PutMapping("/api/v1/competition/{competition}/classification")
    public Classification updateClassification(@PathVariable String competition, @RequestBody Classification classification) {

        return service.updateClassification(competition, classification);
    }
